...
class _SettingsScreenState extends State<SettingsScreen> {
  ...
  Future<void> loadSettings() async {
    ...
    setState(() {
      selectedCountry = prefs.getString('country') ?? 'مصر';
      selectedCity = prefs.getString('city') ?? 'القاهرة';
      notificationsEnabled = prefs.getBool('notifications') ?? true;
      faceVerificationEnabled = prefs.getBool('face_verification') ?? true;
    });
  }
  ...
  Future<void> saveSettings() async {
    ...
    await prefs.setBool('face_verification', faceVerificationEnabled);
